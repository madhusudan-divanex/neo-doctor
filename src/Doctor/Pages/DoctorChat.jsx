import { faBackspace, faBackward, faChevronLeft, faCircleXmark, faClose, faMicrophone, faPaperclip, faPaperPlane, faPen, faPhone, faPlusCircle, faSearch, faUsers, faVideo } from "@fortawesome/free-solid-svg-icons"
...
function DoctorChat({ socket, startCall }) {
    ...
    const fetchConversations = async () => {
        const res = await getSecureApiData("doctor/conversations");
        if (res.success) {
    ...
    return (
        <>
            {loading ? <Loader />
                :
                <>
                    <section className="chat-section py-0">
                        <div className="container">
                            <div className="row">
                                <div className="col-lg-3 pe-lg-0 mb-3 position-relative">
                                    <div className="chat-left-usr-bx ">
                                        <div className="d-flex align-items-center justify-content-between mb-2">
                                            <Link to={"/request-list"} className="thm-btn p-2"><FontAwesomeIcon icon={faChevronLeft} /></Link>
                                            <h6>Message</h6>
                                        ...
                                        <div>
                                            <div className="custom-frm-bx d-flex align-items-center mb-3 gap-2">
                                                ...
                                                <button className=" thm-btn" data-bs-toggle="modal" data-bs-target="#new-Group"><FontAwesomeIcon icon={faUsers} /></button>
                                            ...
                                            <div className="add-chat">
                                                <button className="thm-btn px-3 py-2" onClick={() => setIsSearch(!isSearch)}><FontAwesomeIcon icon={faPlusCircle} /></button>
                                            ...
                                            <div className="">
                                                ...
                                                <div className="custom-frm-bx mb-0">
                                                    ...
                                                    <div className="chat-papper-plane-bx">
                                                        <button onClick={sendMessage} className="chat-papper-plane-btn"><PiPaperPlaneRightFill />
                                                        </button>
                                                    </div>
